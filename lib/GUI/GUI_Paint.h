...
void Paint_DrawInt(UWORD Xpoint, UWORD Ypoint, int16_t number, sFONT *Font, UWORD Color_Foreground, UWORD Color_Background);
...
void Paint_DrawImage1(const UWORD *image, UWORD xStart, UWORD yStart, UWORD W_Image, UWORD H_Image);
